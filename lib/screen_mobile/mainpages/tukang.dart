...
class DaftarTukangDashboard extends StatelessWidget {
  const DaftarTukangDashboard({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      child: Scaffold(
        appBar: AppBar(
          elevation: 0,
          title: const Text("Daftar Tukang Bangunan", style: TextStyle(color: kTextColor, fontSize: 18)),
        ),
        body: ListView(
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                DaftarTukang(
                  title: 'Nama Tukang',
                  desc: 'Pengalaman 4 tahun',
                  lokasi: 'Lokasi Tukang',
                ),
                DaftarTukang(
                  title: 'Nama Tukang',
                  desc: 'Pengalaman 4 tahun',
...
class DaftarTukang extends StatelessWidget {
  ...
  String desc;
  String lokasi;
  DaftarTukang({Key? key, required this.title, required this.desc, required this.lokasi}) : super(key: key);
